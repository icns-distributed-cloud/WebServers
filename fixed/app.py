...
@app.route('/')
@app.route('/fixedcloud', methods=['GET', 'POST'])
def showBooks():
    if request.method == 'POST':
        ...
        print(ten)
        print(ten.isnumeric())
        if ten.isnumeric() and (request.form['genre'].isnumeric() or request.form['genre']=='N' or request.form['genre']=='B' or request.form['genre']==''):
            try:
                editedBook = session.query(Book).filter_by(title=request.form['name']).first()
    ...
    if request.method == 'POST':
        if request.form['name']:
            if request.form['name'].isnumeric():
                editedBook.genre = request.form['name']
            else:
